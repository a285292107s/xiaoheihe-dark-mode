...
`;
	...
	var ICON_MOON = (0, import_jsx_runtime.jsx)("svg", {
		viewBox: "0 0 24 24",
		fill: "none",
		stroke: "currentColor",
		strokeWidth: "1.9",
		...
		"aria-hidden": true,
		children: (0, import_jsx_runtime.jsx)("path", { d: "M21 14.5A8.5 8.5 0 1 1 9.5 3a7 7 0 0 0 11.5 11.5z" })
	});
	var ICON_SUN = (0, import_jsx_runtime.jsxs)("svg", {
		viewBox: "0 0 24 24",
		fill: "none",
		stroke: "currentColor",
		strokeWidth: "1.9",
		...
		children: [(0, import_jsx_runtime.jsx)("circle", {
			...
			cy: "12",
			r: "4"
		}), (0, import_jsx_runtime.jsx)("path", { d: "M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41" })]
	});
	function App() {
		const [dark, setDark] = (0, import_react.useState)(() => isDarkEnabled());
		...
		return (0, import_jsx_runtime.jsx)("button", {
			...
			onClick: toggle,
			children: dark ? ICON_SUN : ICON_MOON
		});
	}
	var uiCss = `
:host { all: initial; }
...
`;
	function mount() {
		...
		(0, import_client.createRoot)(mountPoint).render((0, import_jsx_runtime.jsx)(import_react.StrictMode, { children: (0, import_jsx_runtime.jsx)(App, {}) }));
	}
